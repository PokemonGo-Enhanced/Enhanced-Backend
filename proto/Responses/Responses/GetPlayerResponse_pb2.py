...
_GETPLAYERRESPONSE = _descriptor.Descriptor(
  ...
  full_name='POGOProtos.Responses.GetPlayerResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='unknown1', full_name='POGOProtos.Responses.GetPlayerResponse.unknown1', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='local_player', full_name='POGOProtos.Responses.GetPlayerResponse.local_player', index=1,
...
GetPlayerResponse = _reflection.GeneratedProtocolMessageType('GetPlayerResponse', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:POGOProtos.Responses.GetPlayerResponse)
  ))
