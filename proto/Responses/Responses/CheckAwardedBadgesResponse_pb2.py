...
# source: Responses/CheckAwardedBadgesResponse.proto
...
_CHECKAWARDEDBADGESRESPONSE = _descriptor.Descriptor(
  ...
  full_name='POGOProtos.Responses.CheckAwardedBadgesResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='success', full_name='POGOProtos.Responses.CheckAwardedBadgesResponse.success', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='awarded_badges', full_name='POGOProtos.Responses.CheckAwardedBadgesResponse.awarded_badges', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='awarded_badge_levels', full_name='POGOProtos.Responses.CheckAwardedBadgesResponse.awarded_badge_levels', index=2,
...
CheckAwardedBadgesResponse = _reflection.GeneratedProtocolMessageType('CheckAwardedBadgesResponse', (_message.Message,), dict(
  ...
  __module__ = 'Responses.CheckAwardedBadgesResponse_pb2'
  # @@protoc_insertion_point(class_scope:POGOProtos.Responses.CheckAwardedBadgesResponse)
  ))
